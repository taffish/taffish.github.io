...
# Generated by phylogeny-flow 0.2.0-r1 at 2026-06-13T16:23:28Z
# Commands are provenance records. Re-run from a shell with the same input paths and TAFFISH dependency commands in PATH.

taf-seqkit-v2.13.0-r2 seqkit stats -T -a 'cytc-out/02_intermediate/sequences.safe.fa' > 'cytc-out/00_inputs/input_seqkit_stats.tsv'
taf-mafft-v7.525-r3 mafft --auto --thread '4'  'cytc-out/02_intermediate/sequences.safe.fa' > 'cytc-out/02_intermediate/alignment.raw.fa'
...
taf-iqtree-v3.1.2-r1 iqtree3 -s 'cytc-out/02_intermediate/alignment.trimmed.fa' -m 'LG' -T '4' --seed '20260528' --redo --prefix 'cytc-out/02_intermediate/tree_work/iqtree/iqtree' --quiet
